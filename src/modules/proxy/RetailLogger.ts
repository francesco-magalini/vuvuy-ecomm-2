...
module Commerce.Proxy {
    ...
    export class RetailLogger {
        ...
        public static checkoutCartPrepare3DSRedirect(redirectUri: string): void {
            TsLogging.LoggerBase.writeEvent("checkoutCartPrepare3DSRedirect", 44143, 1, TsLogging.EventChannel.Debug, TsLogging.EventLevel.Informational, [], "", "", "Preparing 3DS redirect to '{0}'.");
        }

        public static checkoutCartAdd3DSRedirectPropertyToFormPost(propertyName: string): void {
            TsLogging.LoggerBase.writeEvent("checkoutCartAdd3DSRedirectPropertyToFormPost", 44144, 1, TsLogging.EventChannel.Debug, TsLogging.EventLevel.Informational, [], "", "", "Added the property '{0}' to FORM while preparing 3DS redirect.");
        }

        public static checkoutCartBegin3DSFormSubmit(): void {
            TsLogging.LoggerBase.writeEvent("checkoutCartBegin3DSFormSubmit", 44145, 1, TsLogging.EventChannel.Debug, TsLogging.EventLevel.Informational, [], "", "", "Form submit to perform 3DS redirect begins.");
        }

        public static checkoutCartEnd3DSFormSubmit(): void {
            TsLogging.LoggerBase.writeEvent("checkoutCartEnd3DSFormSubmit", 44146, 1, TsLogging.EventChannel.Debug, TsLogging.EventLevel.Informational, [], "", "", "Form submit to perform 3DS redirect ends.");
        }
