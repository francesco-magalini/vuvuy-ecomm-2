...
declare module Microsoft.Dynamics.Diagnostics.TypeScriptCore {
    class AppInsightsSink implements Microsoft.Dynamics.Diagnostics.TypeScriptCore.ILoggingSink {
        static readonly appBaseVersion: string;
        private appInsightsProxy;
        constructor(appInsightsInstrumentationKey: string, applicationName: string);
        private application;
        ...
        private overrideObjectField(object, field, value);
    }
}
declare module Microsoft.Dynamics.Diagnostics.TypeScriptCore {
...
declare module Microsoft.Dynamics.Diagnostics.TypeScriptCore {
    ...
    enum EventKeywords {
        ...
        Context = 64,
        SqlOperation = 256,
        OutboundServiceCall = 512,
        InboundServiceCall = 1024,
        GenericEvent = 2048,
        LegacyMonitoringEvent = 4096,
        Telemetry = 8192,
        DataAccess = 4294967296,
    }
    enum EventChannel {
        Admin = 16,
        Operational = 17,
